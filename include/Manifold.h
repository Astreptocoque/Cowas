...
const float purge_angle = 120.85; //is the angle at which the purge hole is aligned with the rotor hole
// const float purge_angle = 353;
// const float angle_offset_pos = 6.3; //5.2 for 160 of speed
// const float angle_offset_neg = 4.9;

const float angle_offset_pos = 5.5;// 3; //5.2 for 160 of speed
